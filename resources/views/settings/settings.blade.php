    ...
    <div class="card-header">Edit Settings</div>
     <div class="card-body">
         ...
         <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active"> {{$error}}
                   </li> @endforeach 
...
<form action="{{route('settings.update')}}" method="POST"  enctype="multipart/form-data" > 
    ...
    </div> <div class="form-group"> <label for="phone_number">Phone </label> 
    <input type="text" class="form-control" name="phone_number"  value="{{$settings->phone_number}}"> 
</div>
 <div class="form-group">
     <label for="blog_email">Email</label> 
<input type="text" class="form-control" name="blog_email"  value="{{$settings->blog_email}}"> </div> 
<div class="form-group">
     <label for="blog_email">background</label> 
<input type="file" class="form-control" name="background"  value="{{$settings->background}}"> </div> 
